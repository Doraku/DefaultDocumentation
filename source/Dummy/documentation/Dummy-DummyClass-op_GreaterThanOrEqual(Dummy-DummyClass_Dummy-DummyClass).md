...
```
#### Parameters
<a name='Dummy-DummyClass-op_GreaterThanOrEqual(Dummy-DummyClass_Dummy-DummyClass)-a'></a>
`a` [DummyClass](./Dummy-DummyClass.md 'Dummy.DummyClass')  
dummy  
  
<a name='Dummy-DummyClass-op_GreaterThanOrEqual(Dummy-DummyClass_Dummy-DummyClass)-b'></a>
