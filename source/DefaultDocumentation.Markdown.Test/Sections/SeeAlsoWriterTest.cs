...
{
    public sealed class SeeAlsoWriterTest : ASectionWriterTest<SeeAlsoWriter>
    {
        [Fact]
        ...
        public void Write_should_not_write_When_not_present() => Test(
            new ClassDocItem(null, AssemblyInfo.Get<ITypeDefinition>($"T:{typeof(SeeAlsoWriterTest).FullName}"), null),
            string.Empty);
        ...
        public void Write_should_write() => Test(
            new ClassDocItem(
                null,
                AssemblyInfo.Get<ITypeDefinition>($"T:{typeof(SeeAlsoWriterTest).FullName}"),
                new XElement("doc",
